...
//    private static final String API_REGISTER_SERVER_TEST = "http://192.168.4.50:81/";
     ...
     * 数据服务
     */
    private String service="http://cx.ikanshu.cn/";
...
//        isTestServer = (boolean) AndroidUtils.getMetaDataFromApplication(UIUtils.getContext(), "TEST_SERVER");
    ...
    public String getService() {
        return "http://cbook.ikanshu.cn/chapter/content?cnid=1272&uid=14804341&imsi=460003481821802&imei=354910071135497&cnsubid=1&umeng=FreeShu_qq&version=3.0.1&oscode=22&model=SM-A8000&other=a&bid=50006748&ids=632173&packname=com.mianfeia.book&vcode=46&channelId=1272&mac=3549100711354977C0BC6CA73CC&brand=samsung&platform=android&appname=cxb";
    }
